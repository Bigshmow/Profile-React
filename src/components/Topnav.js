...
export const Topnav = (props) => {
  ...
  return (
    <div style={s.topnav}>
      <Navbar className='shadow-sm allNav' expand="md">
        <NavbarBrand href="/" className="Logo"><img src="https://profile-dms-pictures.s3.amazonaws.com/DS_Fav.png" style={{height:'50px'}} alt="DS_Logo"></img></NavbarBrand>
